...
import { faHouse, faSearch, faCreditCard, faThumbsUp, faUpload, faTag, faBullhorn, faDollarSign, faDownload, faUserPlus, faCogs, faPlay, faShippingFast, faTruck } from '@fortawesome/free-solid-svg-icons';
...
const HowItWorks: FC = () => {
    ...
    const data = {
        ...
        app: [
            { title: t('app.Step1.title'), description: t('app.Step1.description'), icon: 'fa-search' },
            { title: t('app.Step2.title'), description: t('app.Step2.description'), icon: 'fa-bullhorn' },
            { title: t('app.Step3.title'), description: t('app.Step3.description'), icon: 'fa-shipping-fast' },
            { title: t('app.Step4.title'), description: t('app.Step4.description'), icon: 'fa-truck' }
        ]
    };
